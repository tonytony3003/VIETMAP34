...
public class UIManagerMode3 : MonoBehaviour
{
	public static UIManagerMode3 Instance;
	...
	public void ShowDetailPage(ProvinceData data, Vector3 provinceGlobalPos)
	{
		...
		if (!QuizManagerMode3.Instance.isMode3)
		{
	...
	public void CloseDetailPageAndNext()
	{
		...
		if (detailPanel.activeSelf)
		{
			...
			quizPanel.SetActive(true);
			QuizManagerMode3.Instance.NextQuestion();
		}
	}
